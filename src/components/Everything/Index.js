    ...
    <figure class="flex flex-col container mx-auto rounded-xl p-4 m-8 dark:bg-gray-800 w-11/12">
      ...
      <div class="pt-6 md:p-8 text-center space-y-4">
        ...
        <div className='md:flex flex flex-col'>
          <button>
            <a className='text-stone-500 text-xl relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden font-medium bg-gradient-to-br from-cyan-400 to-blue-500 hover:text-slate-800 focus:outline-none px-5 py-2.5 rounded-md'
              href="https://github.com/coleyrockin">Github</a>
          </button>
          <button>
            <a className='text-stone-700 text-2xl relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden font-medium bg-gradient-to-br from-cyan-500 to-blue-600 hover:text-slate-900 focus:outline-none px-5 py-2.5 rounded-md'
              href="https://coleyrockin.github.io/react-portfolio/">Portfolio</a>
          </button>
          <button>
            <a className='text-stone-800 text-3xl relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden font-medium bg-gradient-to-br from-cyan-600 to-blue-800 hover:text-slate-300  focus:outline-none px-5 py-2.5 rounded-md'
