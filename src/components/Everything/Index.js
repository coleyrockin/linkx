...
function Everything() {
  return (
    <figure class="md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-500">
      ...
      <section>
        <div class="container">
          {/* Google Font? */}
          <h1 class="text-center text-4xl text-zinc-100 ">Boyd C Roberts</h1>
          <h1 class="text-center text-2xl">Full-stack developer</h1>
          <button>
